...
import { SincronizarTabs } from '@/components/educamos/sincronizar-tabs';

export const metadata = { title: 'Sincronizar · BBDD Educamos' };

export default function SincronizarEducamosPage() {
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <header className="sticky top-0 z-20 border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-4 py-3">
          <div>
            <h1 className="font-semibold text-zinc-900 dark:text-zinc-100">BBDD central · Sincronizar</h1>
            <p className="text-xs text-zinc-500">Sube el export de Educamos, revisa el diff y aplica</p>
          </div>
          <Link
