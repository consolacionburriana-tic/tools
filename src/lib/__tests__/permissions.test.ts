...
describe('guardar la selección como diferencia respecto al rol', () => {
  ...
  it('marcar uno de más lo guarda como extra; desmarcar uno del rol, como bloqueado', () => {
    ...
    // El rol tutor trae salidas, bancolibros, puntualidad, horarios, mi-horario y alumnado:
    // lo que no se marca, bloqueado.
    expect(r.modulosBloqueados).toEqual(['bancolibros', 'puntualidad', 'horarios', 'mi-horario', 'alumnado']);
  });
