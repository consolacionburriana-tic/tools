...
const FASES: Fase[] = [
  ...
  },
  {
    ...
    pasos: [
      ...
      {
        n: 11,
        titulo: 'Generar los pedidos',
        donde: 'Editoriales',
        boton: '1 · Generar los pedidos',
        href: '/gestion/licencias/editoriales',
        que: 'Crea en Drive un Google Sheet por editorial: uno con lo de pago y otro con lo del banco de libros. Llevan las columnas de la plantilla de siempre.',
        ojo: 'Si ya había un fichero con el mismo nombre, se reemplaza su contenido en vez de crear otro, así repetir no llena la carpeta de copias.',
      },
      {
        n: 12,
        titulo: 'Pasarlos a PDF y confirmarlos',
        donde: 'Editoriales',
        boton: '2 · Pasar a PDF · 3 · Marcar como pedidos',
        href: '/gestion/licencias/editoriales',
        que: 'El PDF se deja al lado de cada Sheet. Marcar pone el 🧾 a los pedidos que entraron en esos ficheros.',
        ojo: 'Se marca lo que se generó, no lo que haya pendiente en ese momento: un pedido que llegue entre medias no iba en el fichero que se mandó, y sale en la tirada siguiente.',
      },
    ],
  },
  {
    ...
    pasos: [
      {
        n: 13,
        titulo: 'Elegir de qué son los códigos que han llegado',
        donde: 'Envío de licencias',
        boton: 'De pago / Banco de libros',
        href: '/gestion/licencias/envios',
        que: 'Arriba se elige si la tanda es de pago o del banco, y abajo se filtra por libro y curso hasta dejar en pantalla exactamente lo que ha mandado la editorial.',
        ojo: 'De pago y banco NUNCA se mezclan: son dos Excel distintos y dos envíos distintos, igual que los pedidos.',
      },
      {
        n: 14,
        titulo: 'Pegar los códigos',
        donde: 'Envío de licencias',
        boton: 'Pegar códigos',
        href: '/gestion/licencias/envios',
      ...
      {
        n: 16,
        titulo: 'Comprobar que no se ha quedado nadie',
        donde: 'Envío de licencias',
        boton: 'Registro de envíos',
        href: '/gestion/licencias/envios',
        que: 'El filtro «Listas para enviar» dice lo que queda, «Sin correo de destino» a quién no se le puede mandar, y el registro guarda qué salió, a dónde y cuándo.',
        ojo: 'El sello 📤 de los pedidos de pago se pone solo cuando todas las licencias de ese pedido están enviadas.',
      },
    ],
  },
  {
