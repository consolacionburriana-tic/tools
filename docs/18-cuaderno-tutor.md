...
- [x] SQL aditivo `src/db/sql/cuaderno-plantillas-etapas.sql` (añade `etapas` y hace el
      backfill) *(aplicado en Neon el 9-sep-2026)*
...
- [x] SQL aditivo `src/db/sql/profes-nombre-mostrado.sql` *(aplicado en Neon el 9-sep-2026)*
