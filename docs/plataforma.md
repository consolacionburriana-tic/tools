...
| Alumnado (ficha por alumno) | ✅ | ✅ | 🟡 (navegador por clase, buscador y ficha completa con los 8 módulos, todo copiable de un toque; alcance por etapa verificado contra la app. Protección de datos (fotos sí/no + documento Prodat) con vista propia: contadores-filtro, ámbito por etapa/clase, edición por celda y masiva, y PDF por etapas. **Pendiente de aplicar su SQL en Neon**) | [`21-alumnado.md`](./21-alumnado.md) |
