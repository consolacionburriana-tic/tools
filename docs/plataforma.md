...
| Evaluaciones de actividades | ✅ | ✅ | ✅ (Fases 0-4 en producción: editor con presets, formulario público, envío por correo (Resend), dashboard y comparativas · evaluación conjunta alumnado + profesorado + familias) | [`16-evaluaciones.md`](./16-evaluaciones.md) |
