...
| Alumnado (ficha por alumno) | ✅ | ✅ | 🟡 (navegador por clase, buscador y ficha completa con los 8 módulos, todo copiable de un toque; alcance por etapa verificado contra la app. Protección de datos —imagen y voz, redes, AMPA, ONG— editable desde la ficha y en tabla por clase (masivos por columna), igual que banco de libros y AMPA, que además tienen su propia pestaña por clase con masivos —el mismo dato y el mismo permiso que su módulo, solo que también desde aquí—; SQL ya aplicado en Neon, falta probarlo en uso real) | [`21-alumnado.md`](./21-alumnado.md) |
